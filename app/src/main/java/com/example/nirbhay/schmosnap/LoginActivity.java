...
public class LoginActivity extends AppCompatActivity
{
    ...
    private ImageView googleSignInButtton;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        googleSignInButtton=(ImageView)findViewById(R.id.google_signin_button);
        ...
        googleSignInButtton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
            signIn();
